    ...
    <section id="leaderboard" className="relative py-32 px-4 overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <AnimatedSection className="mb-12">
          <div className="glass rounded-2xl p-6 max-w-md mx-auto border-cyan-500/30">
            ...
            <AnimatePresence>
              {leaderboardData.map((user, index) => (
                <motion.div
                  ...
                  className={`grid grid-cols-6 gap-4 p-4 items-center border-b border-white/5 hover:bg-white/5 transition-colors duration-200 ${
